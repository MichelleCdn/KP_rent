    ...
    <div class="row mb-32 g-32">
                        ...
                        <div class="col-md-4 col-6">
                            <div
                                ...
                                <div class="card-body">
                                    ...
                                    <span class="hp-caption mt-4 d-block fw-normal hp-text-color-black-60"> April 2022
                                    </span>
                ...
                <div class="col-12">
                    <div class="row align-items-center justify-content-between">
                        <div class="col-sm-6 col-12">
                            <span class="h3 fw-semibold hp-text-color-black-bg hp-text-color-dark-0 d-block mb-0"> History
                            </span>
        ...
        <div class="col hp-analytics-col-2">
            <div class="row g-32">
                    ...
                    <div class="overflow-hidden position-relative hp-bg-primary-1 pt-24 px-24 pb-18 rounded-5"
                        ...
                        <div class="row">
                            ...
                            <div class="mt-32 col-12">
                                <span class="h4 d-block hp-text-color-black-0"> 4512 0000 0000 0000 0000 </span>
                            </div>

                            <div class="mt-4 mb-n16 col-12">
                                <div class="row align-items-center justify-content-between">
                                    <div class="col">
                                        <span class="hp-caption fw-medium hp-text-color-black-0"> Edward Adams </span>
                                    </div>

                                    <div class="d-flex hp-flex-none w-auto col">
                                        <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                            viewBox="0 0 24 24" height="64" width="64"
                                            xmlns="http://www.w3.org/2000/svg" class="hp-text-color-black-0">
                                            <g>
                ...
                <div class="col-12">
                    <span class="h3 d-block fw-semibold hp-text-color-black-bg hp-text-color-dark-0 mb-0"> Recent
                        Activities </span>
                    ...
                    <div class="row mt-24">
                        <div
                            ...
                            <div class="row align-items-end justify-content-between">
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="hp-flex-none w-auto ps-0 col">
                                            <span
                                                ...
                                                Zendesk </span>
                                            <span class="d-block hp-caption fw-normal hp-text-color-black-60"> 05 Dec 2021
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="hp-flex-none w-auto col">
                                    <span class="h5 hp-text-color-black-bg hp-text-color-dark-0"> $ 500.00 </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="row align-items-end justify-content-between">
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="hp-flex-none w-auto ps-0 col">
                                            <span
                                                class="d-block hp-p1-body fw-medium hp-text-color-black-bg hp-text-color-dark-0">
                                                Sales Force </span>
                                            <span class="d-block hp-caption fw-normal hp-text-color-black-60"> 24 Dec 2021
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="hp-flex-none w-auto col">
                                    <span class="h5 hp-text-color-black-bg hp-text-color-dark-0"> $ 337.00 </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="row align-items-end justify-content-between">
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="hp-flex-none w-auto ps-0 col">
                                            <span
                                                class="d-block hp-p1-body fw-medium hp-text-color-black-bg hp-text-color-dark-0">
                                                Apple </span>
                                            <span class="d-block hp-caption fw-normal hp-text-color-black-60"> 29 Dec 2021
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="hp-flex-none w-auto col">
                                    <span class="h5 hp-text-color-black-bg hp-text-color-dark-0"> $ 320.67 </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="row align-items-end justify-content-between">
                                ...
                                <div class="hp-flex-none w-auto col">
                                    <span class="h5 hp-text-color-black-bg hp-text-color-dark-0"> $ 127.00 </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="row align-items-end justify-content-between">
                                ...
                                <div class="hp-flex-none w-auto col">
                                    <span class="h5 hp-text-color-black-bg hp-text-color-dark-0"> $ 28.00 </span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12">
                    <span class="h3 d-block fw-semibold hp-text-color-black-bg hp-text-color-dark-0 mb-0"> Upcoming
                        Payments </span>
                    <span class="hp-p1-body d-block mt-4">05 Dec 2021</span>
